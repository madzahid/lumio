...
![Lumio hero section with radial glow background and centered heading](https://lumio.xuro.net/wp-content/uploads/screenshot-hero.png)

### Homepage — Category Cards
![Lumio pastel category card grid showing Cybersecurity, AI, Technology, Quantum Computing, Robotics and Smart Home](https://lumio.xuro.net/wp-content/uploads/screenshot-cards.png)

### Single Post
![Lumio single post layout with author meta, featured image and floating table of contents](https://lumio.xuro.net/wp-content/uploads/screenshot-single.png)
