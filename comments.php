...
<div id="comments" class="comments-area">
    ...
    <?php if (have_comments()) : ?>
        <h2 class="comments-title">
            <?php
            $hackmonks_comment_count = get_comments_number();
            if ('1' === $hackmonks_comment_count) {
                printf(
                    esc_html__('One comment on &ldquo;%1$s&rdquo;', 'hackmonks'),
                    '<span>' . get_the_title() . '</span>'
                );
            } else {
                printf( 
                    esc_html(_nx('%1$s comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', $hackmonks_comment_count, 'comments title', 'hackmonks')),
                    number_format_i18n($hackmonks_comment_count),
                    '<span>' . get_the_title() . '</span>'
                );
            }
            ?>
        ...
        if (!comments_open()) :
            ?>
            <p class="no-comments"><?php esc_html_e('Comments are closed.', 'hackmonks'); ?></p>
            <?php
        endif;
